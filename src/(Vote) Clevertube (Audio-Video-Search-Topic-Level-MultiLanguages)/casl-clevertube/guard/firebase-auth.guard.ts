...
import { ABILITY_METADATA_KEY } from '../../common-clevertube/constants/global.constant';
import { ForbiddenExc } from '../../common-clevertube/exceptions/custom.exception';
...
@Injectable()
export class FirebaseAuthGuard extends AuthGuard('firebase-casl') {
  constructor(

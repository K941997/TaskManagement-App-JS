...
export class OK11652084210669 implements MigrationInterface {
    name = 'OK11652084210669'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_entity_role_enum" AS ENUM('user', 'premium', 'admin', 'super_admin')`);
        await queryRunner.query(`CREATE TABLE "user_entity" ("id" SERIAL NOT NULL, "name" character varying, "role" "public"."user_entity_role_enum" NOT NULL DEFAULT 'user', "isAdmin" boolean, "username" character varying NOT NULL, "password" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "address_id" integer, CONSTRAINT "UQ_9b998bada7cff93fcb953b0c37e" UNIQUE ("username"), CONSTRAINT "REL_565718033df1b968e4f738db63" UNIQUE ("address_id"), CONSTRAINT "PK_b54f8ea623b17094db7667d8206" PRIMARY KEY ("id"))`);
